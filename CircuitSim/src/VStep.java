...
public class VStep implements Component{
	protected String id;
	...
	public VStep(String id, int nodeOne, int nodeTwo, double amplitude, double riseTime, double minTime, double maxTime, int numSteps){
		this.id = id;
